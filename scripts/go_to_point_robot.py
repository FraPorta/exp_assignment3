...
def planning(goal):
	...
	feedback = exp_assignment3.msg.PlanningFeedback()
	result = exp_assignment3.msg.PlanningResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('reaching_goal', exp_assignment3.msg.PlanningAction, planning, auto_start = False)
    act_s.start()
